...
class copying
{
    ...
    public void CopyChartFromXlsx2Pptx(string SourceFile, string TargetFile, string targetppt)
    {
...
namespace spreadsheetToPPTchart

{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string SourceFile = "ChartsLine.xlsx";
            string mediator = "C://Users//mysel//source//repos//spreadsheetToPPTchart//spreadsheetToPPTchart//source.xlsx";
            string filepath = "C://Users//mysel//source//repos//spreadsheetToPPTchart//spreadsheetToPPTchart//graph.pptx";

            CreatePresentation(filepath);
            string target = "C://Users//mysel//source//repos//spreadsheetToPPTchart//spreadsheetToPPTchart//graph.pptx";
            copying c = new copying();

            c.CopyChartFromXlsx2Pptx(SourceFile,mediator,target);
